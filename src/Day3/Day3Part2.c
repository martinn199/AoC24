...
int main() {
    ...
    for (index = 0; index < i; index++)
    {
        ...
        /* Check 1. Should the instructions be disabled or not? */
        ...
        /* Check 2. Check if the line starts with "mul"*/
            ...
            data[index + 2] == 'l' && data[index + 3] == '(')
        {
            ...
            /* Check 3. Check if there is a ',' as seperator between the numbers */
            if (data[index] == ',')
            {
                index++;
                /* Get second number*/
            ...
            /* Check 4. Check if there is a valid end*/
            if (data[index] == ')')
            {
                sum += number1 * number2;
            }
